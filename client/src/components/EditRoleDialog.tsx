...
const permissionLabels = {
  ...
  manageAccounting: { label: "Manage Accounting", description: "Can create open items and record payments" },
  viewInventory: { label: "View Inventory", description: "Can view warehouses and stock levels" },
  manageInventory: { label: "Manage Inventory", description: "Can book stock movements and inventory counts" },
  viewPurchasing: { label: "View Purchasing", description: "Can view suppliers and purchase orders" },
  managePurchasing: { label: "Manage Purchasing", description: "Can create POs, goods receipts and supplier invoices" },
  viewReturns: { label: "View Returns", description: "Can view RMA / returns" },
  manageReturns: { label: "Manage Returns", description: "Can create and process returns and credit notes" },
  ...
  const form = useForm<EditRoleFormData>({
    ...
    values: role ? {
      ...
      permissions: {
        ...
        manageAccounting: !!(role.permissions as any).manageAccounting,
        viewInventory: !!(role.permissions as any).viewInventory,
        manageInventory: !!(role.permissions as any).manageInventory,
        viewPurchasing: !!(role.permissions as any).viewPurchasing,
        managePurchasing: !!(role.permissions as any).managePurchasing,
        viewReturns: !!(role.permissions as any).viewReturns,
        manageReturns: !!(role.permissions as any).manageReturns,

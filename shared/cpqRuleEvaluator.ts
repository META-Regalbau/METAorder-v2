 ...
 *
 * Shared zwischen Server (constraintEngine.ts, sceneBuilder.ts, cpqBillOfMaterials.ts)
 * und Client (CpqCompatibilityMatrix.tsx) – Single Source of Truth für die
 * Bedingungs-Auswertung, damit die Admin-Kompatibilitätsmatrix exakt dieselbe
 * Logik anzeigt, die der Server bei der echten Konfiguration anwendet.
 */
